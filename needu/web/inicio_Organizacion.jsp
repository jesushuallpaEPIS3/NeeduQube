        ...
        <div class="fila">
            <div class="columna-mitad">
                <div class="modulo texto fondo-claro">
                    <div class="texto-interior"><h4>Organizacion</h4></div>
                </div>
                <div class="modulo texto fondo-claro">
                    <div class="texto-interior"><h1>Organizacion</h1></div>
                </div>
                <div class="modulo texto fondo-claro">
                    <div class="texto-interior">
                        <p>Trabajamos en colaboración con organizaciones como la tuya para lograr un impacto significativo en la sociedad. Tu compromiso es fundamental para alcanzar nuestras metas compartidas. Juntos, podemos hacer la diferencia.</p>
                    </div>
                </div>
            </div>
...
<h1>Todas las Oportunidades creadas por distintas Organizaciones:</h1>
